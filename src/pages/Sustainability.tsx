        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-black/40 backdrop-blur-xl rounded-3xl border border-white/10 p-8 md:p-12">
            ...
            <div className="space-y-8 text-gray-300 leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Sustainable Materials</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Eco-Friendly Production</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Packaging</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Carbon Neutral Shipping</h2>
                <p>
