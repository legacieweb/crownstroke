        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-black/40 backdrop-blur-xl rounded-3xl border border-white/10 p-8 md:p-12">
            ...
            <div className="space-y-8 text-gray-300 leading-relaxed">
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Welcome to Our Affiliate Program</h2>
                <p>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-bold text-white">Commission Rate</h3>
                    <p>Earn 10% commission on every sale you generate.</p>
                  </div>
                  <div>
                    <h3 className="font-bold text-white">Cookie Duration</h3>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Benefits of Joining</h2>
