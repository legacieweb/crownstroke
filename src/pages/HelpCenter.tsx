        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-black/40 backdrop-blur-xl rounded-3xl border border-white/10 p-8 md:p-12">
            ...
            <div className="space-y-8 text-gray-300 leading-relaxed">
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Welcome to Our Help Center</h2>
                <p>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-bold text-white">How do I create an account?</h3>
                  ...
                  <div>
                    <h3 className="font-bold text-white">How do I update my account information?</h3>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Ordering</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="font-bold text-white">How do I place an order?</h3>
                    <p>Select a product, customize it using our designer tool, and follow the checkout process.</p>
                  </div>
                  <div>
                    <h3 className="font-bold text-white">How do I track my order?</h3>
                    <p>Once your order has been shipped, you will receive a confirmation email with tracking information.</p>
                  </div>
                  <div>
                    <h3 className="font-bold text-white">Can I cancel or modify my order?</h3>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Product Customization</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="font-bold text-white">How do I customize a product?</h3>
                    <p>Select a product and click on the "Customize" button to access our designer tool.</p>
                  </div>
                  <div>
                    <h3 className="font-bold text-white">What file formats are supported?</h3>
                    <p>We support JPG, PNG, and SVG file formats.</p>
                  </div>
                  <div>
                    <h3 className="font-bold text-white">What is the maximum file size?</h3>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-bold text-white">How long does shipping take?</h3>
                    <p>Shipping times vary depending on your location and the shipping method selected.</p>
                  </div>
                  <div>
                    <h3 className="font-bold text-white">What is your return policy?</h3>
                  ...
                  <div>
                    <h3 className="font-bold text-white">How do I return an item?</h3>
