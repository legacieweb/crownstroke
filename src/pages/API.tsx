        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-8 md:p-12">
            ...
            <div className="space-y-8 text-slate-600 leading-relaxed">
              <section>
                <h2 className="text-2xl font-bold text-slate-900 mb-4">Welcome to Our API Documentation</h2>
                <p>
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900">Designs</h3>
              ...
              <section>
                ...
                <div className="mt-4 bg-slate-100 p-4 rounded-lg overflow-x-auto">
